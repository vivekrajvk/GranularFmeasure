function [f_measure,recall,p,summary_length,nn_f_meas, f_measure_seg] = summe_evaluateSummary(summary_selection,videoName,HOMEDATA,testIdx,evalIOU)
...
% f_measure is the mean pairwise f-measure used in Gygli et al. ECCV 2014
  ...
  if evalIOU
      ...
      f_measure_seg=mean(f_measure_seg);
  else
      f_measure_seg=-1;
  end
